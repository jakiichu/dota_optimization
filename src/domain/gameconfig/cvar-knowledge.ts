...
export const IMPACT_LABEL: Record<CvarImpact, string> = {
  gpu: 'снимает работу с видеокарты',
  cpu: 'снимает работу с процессора',
  both: 'снимает работу с процессора и видеокарты',
  gameplay: 'меняет игру, а не производительность',
  cosmetic: 'только внешний вид',
  none: 'на производительность не влияет',
};
