...
export const SEVERITY_ORDER: readonly Severity[] = ['critical', 'warning', 'unknown', 'info', 'ok'];
...
export const IMPACT_GROUP_HINT: Record<ImpactGroup, string> = {
  cpu:
    'Выключив их, вы снимете работу с процессора. Сколько именно кадров это ' +
    'даст на вашей машине — покажет только запись, таблица этого знать не может.',
  both:
    'Выключив их, вы снимете работу и с процессора, и с видеокарты. ' +
    'Сколько это даст — покажет только запись.',
  gpu:
    'Выключив их, вы снимете работу с видеокарты. Сколько именно кадров это ' +
    'даст на вашей машине — покажет только запись, таблица этого знать не может.',
  gameplay:
    'Цвета, подсветка, управление. Скорость они не меняют — только то, ' +
  ...
  unknown:
    'Имя переменной есть, а что она делает — мы не знаем. Придумывать не ' +
